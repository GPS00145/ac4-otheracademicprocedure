...
import 'package:fusion/screens/Faculty/Faculty_Graduate_Seminar.dart';
import 'package:fusion/screens/Faculty/faculty_homepage.dart';
import 'package:fusion/screens/Leave/graduate_Seminar.dart';
import 'package:fusion/screens/Leave/assistantclaimstatus.dart';
import 'package:fusion/screens/Leave/leave_application.dart';
...
import 'package:fusion/screens/Leave/leave_application.dart';
import 'package:fusion/screens/Leave/homepage.dart';
import 'package:fusion/screens/Leave/graduate_Seminar.dart';
import 'package:fusion/screens/Leave/check_nodues.dart';
...
import 'package:fusion/screens/Leave/bonafide.dart';
import 'package:fusion/screens/Leave/homepage.dart';
    ...
    return MediaQuery(
      ...
      child: MaterialApp(
        ...
        routes: {
          ...
          '/faculty_homepage':(context) => FacultyHomepage(),
          '/Leave_homepage':(context) => HomePage(),
          '/assistantshipclaimstatus':(context) => AssistantClaimStatus(),
          '/Leave_HOmepage/graduateseminar':(context) => GraduateSeminar(),
          '/Leave_checknodues':(context) => CheckNoDues(),
          '/Leave_application':(context) =>LeaveApplicationForm(),
          ...
          '/academic_home_page/bonafied': (context) => bonafied(),
